...
int main(void)
{
  ...
  /* Create the queue(s) */
  /* creation of recvQueue */
  recvQueueHandle = osMessageQueueNew (8, 8, &recvQueue_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : CH_Switch_CAN_Pin CH_Switch_BT_Pin */
  GPIO_InitStruct.Pin = CH_Switch_CAN_Pin|CH_Switch_BT_Pin;
